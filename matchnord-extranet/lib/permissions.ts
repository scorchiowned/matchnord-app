...
export class PermissionManager {
  ...
  /**
   * Get accessible tournaments for a user
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  static getAccessibleTournaments(_user: User): string[] {
    // This would typically query the database for tournament assignments
    // For now, return empty array - will be implemented with database queries
    return [];
  }

  /**
   * Get accessible matches for a user
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  static getAccessibleMatches(_user: User): string[] {
    // This would typically query the database for match assignments
    // For now, return empty array - will be implemented with database queries
    return [];
  }
  ...
  static getUserPermissions(
    ...
    const basePermissions = PermissionManager.getBasePermissions(user.role);

    if (resourceId) {
      return basePermissions.filter((permission) =>
        PermissionManager.evaluatePermission(
          permission,
          user,
          resource,
          resourceId
  ...
  static getBasePermissions(role: UserRole): Permission[] {
